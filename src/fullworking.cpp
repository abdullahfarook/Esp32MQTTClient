...
// const char* mqtt_host = "192.168.1.18";
...
// MQTTPubSub::PubSubClient<30006> mqtt;  // constructor overload exists
...
//   mqtt.setKeepAliveTimeout(120); // Set keep-alive interval to 60 seconds
// mqtt.setTimeout(20000); // Set timeout to 10 seconds
...
//     Serial.println("Received Data => Topic: " + topic + " Payload: " + payload);
//   });
